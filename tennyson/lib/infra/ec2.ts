...
const debAMIs = {
  ...
  "ap-northeast-1": {
    arm: "ami-0c8d182fa5128de8b",
    amd: "ami-0944e03d5665fd60d",
  },
  "ap-northeast-2": {
    arm: "ami-0781712dc68b750fb",
    amd: "ami-0548636fa1c2b8677",
  },
  "ap-northeast-3": {
    arm: "ami-0382b715629118313",
    amd: "ami-0696d50e5f400e1c4",
  },
  ...
  "ap-southeast-1": {
    arm: "ami-030cd3d2d244949b1",
    amd: "ami-0193f684d5be7b642",
  },
  "ap-southeast-2": {
    arm: "ami-09e3850be81fe9cc5",
    amd: "ami-0c17275d10089f0d2",
  },
  "ap-southeast-3": {
    arm: "ami-07e375a07e3b5e5cd",
    amd: "ami-0554560a4b6346769",
  },
  "ap-southeast-4": {
    arm: "ami-06b2321617b9a3cf7",
    amd: "ami-00b6abd6d4cec53d4",
  },
  "ap-southeast-5": {
    arm: "ami-08adcd65063e88958",
    amd: "ami-05419fe902981d94d",
  },
  "ap-southeast-7": {
    arm: "ami-093f522c50cd6d5d4",
    amd: "ami-0dcfcf6bb64db2a7e",
  },
  "ca-central-1": {
    arm: "ami-090e84750640e57a5",
    amd: "ami-0d5b7ed2156225d60",
  },
  "ca-west-1": { arm: "ami-0af5eb48a171386bf", amd: "ami-093fb5647d0b16be1" },
  "eu-central-1": {
    arm: "ami-091ce57938e5a70bb",
    amd: "ami-05402d6aa168d6c36",
  },
  "eu-central-2": {
    arm: "ami-04c507537651dec50",
    amd: "ami-0b8425a9cac51aaad",
  },
  ...
  "il-central-1": {
    arm: "ami-04695beb2b8672910",
    amd: "ami-0f685d120d71595b4",
  },
  "me-central-1": {
    arm: "ami-0cc4a2a16a7167c2c",
    amd: "ami-089cb2b8dc3f0cdd7",
  },
  "me-south-1": { arm: "ami-03a3cfcfae8cec211", amd: "ami-05c9011e13bd1a74a" },
  "mx-central-1": {
    arm: "ami-0f08e599569bbf0a1",
    amd: "ami-0e855e6ca0a2cdc10",
  },
...
export async function purgeByName(
  name: string,
